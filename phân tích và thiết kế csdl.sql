...
CREATE TABLE `customers` (
  ...
  KEY `fk_employee` (`employeeNumber`),
  CONSTRAINT `fk_employee` FOREIGN KEY (`employeeNumber`) REFERENCES `emplyees` (`employeeNumber`)
...
CREATE TABLE `orderdetails` (
  ...
  KEY `fk_products` (`productCode`),
  KEY `fk_orders` (`orderNumber`),
...
CREATE TABLE `orders` (
  ...
  `comments` text,
  `quantityOrderd` int(11) NOT NULL,
...
CREATE TABLE `products` (
  ...
  KEY `fk_productLine` (`productLine`),
...
-- Dump completed on 2019-03-16 17:15:49
